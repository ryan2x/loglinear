...
public class TableFactorTest {
  ...
  public static class TableFactorToMarginalize {
    TableFactor factor;
    List<Integer> subsetList;
    int[] subset;

    public TableFactorToMarginalize(TableFactor factor, int[] subset, List<Integer> subsetList) {
      this.factor = factor;
      this.subset = subset;
  ...
  public static class TableFactorToMarginalizeGenerator extends Generator<TableFactorToMarginalize> {
    TableFactorGenerator tableFactorGenerator = new TableFactorGenerator(TableFactor.class);
    public TableFactorToMarginalizeGenerator(Class<TableFactorToMarginalize> type) {
      super(type);
    }
  ...
  public static class PartiallyObservedConstructorDataGenerator extends Generator<PartiallyObservedConstructorData> {
    ...
    public PartiallyObservedConstructorData generate(SourceOfRandomness sourceOfRandomness, GenerationStatus generationStatus) {
      ...
      data.factor = new GraphicalModel.VectorFactor(t, neighborIndices);
